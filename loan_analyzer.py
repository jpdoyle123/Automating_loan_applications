...
average_loan_amount = total / number_of_loans
...
# Print each variable.
FV = loan.get("future_value", 1000)
remaining_months = loan.get("remaining_months", 9)
print(f"the Future value is", FV)
print(f"and the remaining months are", remaining_months)
...
pv = FV / (1+.20/12)**remaining_months
...
price = loan.get("loan_price", 500)
if pv > price: 
    print(f"the loan is worth at least the cost to buy it!")
else:
    print(f"The loan is too expensive!")
...
def calculate_present_value(future_value, remaining_months, annual_discount_rate):
    ...
    print(f"your present value is: ", present_value)
...
for item in loans:
    if (item.get("loan_price")) > 500:
        inexpensive_loans.append(item.get("loan_price"))
